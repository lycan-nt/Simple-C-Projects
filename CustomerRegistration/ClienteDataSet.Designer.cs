...
namespace CustomerRegistration {
    ...
    public partial class ClienteDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string Nome, string Email, string Telefone, bool Ativo) {
...
namespace CustomerRegistration.ClienteDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([ClienteID] = @Original_ClienteID) AND ([Nome] = @Original_Nome) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Ativo = 1 AND [Ativo] IS NULL) OR ([Ativo] = @Original_Ativo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Nome], [Email], [Telefone], [Ativo]) VALUES (@Nome" +
                ", @Email, @Telefone, @Ativo);\r\nSELECT ClienteID, Nome, Email, Telefone, Ativo FR" +
                "OM Clientes WHERE (ClienteID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nome] = @Nome, [Email] = @Email, [Telefone] = @Telefone, [Ativo] = @Ativo WHERE (([ClienteID] = @Original_ClienteID) AND ([Nome] = @Original_Nome) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Ativo = 1 AND [Ativo] IS NULL) OR ([Ativo] = @Original_Ativo)));
SELECT ClienteID, Nome, Email, Telefone, Ativo FROM Clientes WHERE (ClienteID = @ClienteID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerRegistration.Properties.Settings.Default.ClienteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteID, Nome, Email, Telefone, Ativo FROM dbo.Clientes";
        ...
        public virtual int Delete(int Original_ClienteID, string Original_Nome, string Original_Email, string Original_Telefone, global::System.Nullable<bool> Original_Ativo) {
        ...
        public virtual int Insert(string Nome, string Email, string Telefone, global::System.Nullable<bool> Ativo) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Email, string Telefone, global::System.Nullable<bool> Ativo, int Original_ClienteID, string Original_Nome, string Original_Email, string Original_Telefone, global::System.Nullable<bool> Original_Ativo, int ClienteID) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
            ...
            if ((Original_Ativo.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_Ativo.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Email, string Telefone, global::System.Nullable<bool> Ativo, int Original_ClienteID, string Original_Nome, string Original_Email, string Original_Telefone, global::System.Nullable<bool> Original_Ativo) {
            return this.Update(Nome, Email, Telefone, Ativo, Original_ClienteID, Original_Nome, Original_Email, Original_Telefone, Original_Ativo, Original_ClienteID);
        }
    }
